    ...
    checkPercentile(range) {
        ...
        if (n && +n[0] >= 0 && +n[0] <= 100) {
            if (/_/.test(this.value)) {
                result = Util.createDiagnostic(range, `Underscore is deprecated, use percentile(${n[0]}) instead`, DiagnosticSeverity.Warning);
            }
