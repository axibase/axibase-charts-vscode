define(["require", "exports", "vscode-languageserver", "../../../messageUtil", "../../../util", "./forSeries", "./forWidget"], function (require, exports, vscode_languageserver_1, messageUtil_1, util_1, forSeries_1, forWidget_1) {
    "use strict";
    ...
    function getRule(checksMap) {
        return (section) => {
            ...
            checksMap.forEach((conditions, dependent) => {
                ...
                if (msg.length > 0) {
                    diagnostics.push(util_1.createDiagnostic(dependentSetting.textRange, messageUtil_1.uselessScope(dependentSetting.displayName, `${msg.join(", ")}`), vscode_languageserver_1.DiagnosticSeverity.Warning));
                }
            });
            return diagnostics;
        };
